...
class JailBreak:
    ...
    def run(self, instructions):
        ...
        triggers[instructions[0]] = self.trigger_generator.run(instructions)

        logging_generator = pd.concat([logging_generator, self.trigger_generator.return_logging()], ignore_index=True)
